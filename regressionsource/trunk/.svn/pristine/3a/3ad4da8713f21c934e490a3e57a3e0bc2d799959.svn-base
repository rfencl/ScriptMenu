...
public class CharacterizationTestTimed  extends CyclingTestBase {
	// Devices
	...
	// Constructor
	public CharacterizationTestTimed(String modbusHostName, int modbusPort, int modbusUnitId, boolean enableModbusLogging) {
	...
	public static void main(String[] args) throws Throwable {
		try {
			CharacterizationTestTimed mCharacterizationTest = new CharacterizationTestTimed(PowinProperty.TURTLEHOST.toString(), 4502, 255, false);
