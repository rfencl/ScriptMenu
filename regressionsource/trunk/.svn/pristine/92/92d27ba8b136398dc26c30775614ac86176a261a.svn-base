...
public class BatteryPackVoltageNotificationCommands {
	final static Logger LOG = LogManager.getLogger(BatteryPackVoltageNotificationCommands.class.getName());
	...
	public BatteryPackVoltageNotificationCommands(int arrayIndex, int stringIndex) {
	...
	public static void disableBatteryPackVoltageNotificationConfiguration() {
		SetBatteryPackVoltageNotificationConfiguration mConfig = BatteryPackVoltageNotificationCommands.getDisabledBatteryPackVoltageNotificationConfiguration();
		Command mCommand = BatteryPackVoltageNotificationCommands.getCommand(mConfig);
		BatteryPackVoltageNotificationCommands.postCommand(mCommand);
	}
	...
	public static void resetDefaultsBatteryPackVoltageNotificationConfiguration(){
		SetBatteryPackVoltageNotificationConfiguration mConfig = BatteryPackVoltageNotificationCommands.getDefaultBatteryPackVoltageNotificationConfiguration();
		Command mCommand = BatteryPackVoltageNotificationCommands.getCommand(mConfig);
		BatteryPackVoltageNotificationCommands.postCommand(mCommand);
	}
	...
	public static void setNotification(NotificationCodes awType, int set, int clear) {
		...
		case CELL_HIGH_VOLTAGE_WARNING:
			BatteryPackVoltageNotificationCommands.setHighCellGroupVoltageWarning(set, clear);
			break;
		case CELL_LOW_VOLTAGE_WARNING:
			BatteryPackVoltageNotificationCommands.setLowCellGroupVoltageWarning(set, clear);
			break;
		case CELL_HIGH_VOLTAGE_DELTA_WARNING:
			BatteryPackVoltageNotificationCommands.setHighCellGroupVoltageDeltaWarning(set, clear);
			break;
		case CELL_HIGH_VOLTAGE_ALARM:
			BatteryPackVoltageNotificationCommands.setHighCellGroupVoltageAlarm(set, clear);
			break;
		case CELL_LOW_VOLTAGE_ALARM:
			BatteryPackVoltageNotificationCommands.setLowCellGroupVoltageAlarm(set, clear);
			break;
		case CELL_HIGH_VOLTAGE_DELTA_ALARM:
			BatteryPackVoltageNotificationCommands.setHighCellGroupVoltageDeltaAlarm(set, clear);
			break;
		default:
			break;
		}
